/**
 * FIRST-PAID-VERIFY-WORKER-JWT-BUNDLE-INIT-REMEDIATION-01 -- build-output probe CORE.
 * (SETTLEMENT-OBSERVABILITY-01: shared by the public-API and continuation-host
 * probe entries so both payment-capable Workers run the identical behavioural
 * contract.)
 *
...
export const PROBE_PATH = '/__cdp_jwt_bundle_probe';
