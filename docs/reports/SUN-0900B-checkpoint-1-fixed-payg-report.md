...
## Terminology correction (this turn)

The prior turn's "successful external mutations = 1" undercounted. Corrected:
...
```
pnpm nevermined:recover -- --payment-id pay_7858b2f7de124dce98395a973eed2208
```

Confirmed `RUN_LIVE_NEVERMINED=MISSING`, `RUN_LIVE_X402=MISSING` immediately
before and after. Output (abbreviated):

```
Durable payment state (sanitized): { lifecycle_stage: 'settlement_pending', consumed: false, delegation_id: 'f2c64337-3bb7-4109-a99a-bb3642addffb', ... }
Durable artifacts loaded (sanitized): job=32e1909d-4abf-4c80-88de-57400cc8e3a3 receipt_id=rcpt_5498e83ce1a66f9f4b5bc4b7 output_hash=sha256:b39dae0d16abb1d3a227393dde9b175551c2fdbe8f7d872d7e757f47b063d6b3
External reconciliation classification: SETTLED
Settled transaction (sanitized): { status: 'succeeded', providerTransactionId: '0x847a6da0a6a63f1f12838bbe9269b8fd9798997b0680b0146b7147fcb715f417', amountCents: '1', createdAt: '2026-08-15T04:34:11.972Z' }
Transitioned: settlement_pending -> settled_external
PaymentServiceLink built and extended: { link_id: 'lnk_0b99203f055735b3a390d2f7', link_hash: 'sha256:ef32fcb64d16ad3c9095b38bc130e66acc1038d4bd507b4be6eb1b95881d4676' }
Transitioned: link_verified -> settled -> consumed
Job stays at REFUND_REQUIRED (no legal edge to DELIVERED from there in the frozen JobState machine) — payment_attempts.lifecycle_stage/consumed_at and the PaymentServiceLink above are the authoritative record.
Final result persisted to x402_service_results.
RECOVERY COMPLETE. verify+=0 execute+=0 settle+=0 delegation_creations+=0 tokens+=0 jobs+=0
```

Direct `sqlite3` verification against the real persistent D1 confirmed:

```
lifecycle_stage: settled
consumed_at: 2026-08-15T04:57:13.253Z
...
before `sellerReconciliationClient` is even constructed.
