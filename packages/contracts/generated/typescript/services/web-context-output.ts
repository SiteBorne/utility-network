// Generated from /Users/meta4ickal/SITEBORNE Utility Network/schemas/services/web-context-output.schema.json
  // DO NOT EDIT MANUALLY — regenerate from canonical schema
  
  /**
 * Output schema for web_context_verified.v1 service. Must be a valid PCC 1.0.0 document
 * with required net.siteborne.web-context.v1 extension.
 *
 ...
 */
export interface WebContextOutput {
    claims:       Claim[];
 ...
 * Service identifier
 */
export type ServiceID = "web_context_verified.v1";
