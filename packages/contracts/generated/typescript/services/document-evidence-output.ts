// Generated from /Users/meta4ickal/SITEBORNE Utility Network/schemas/services/document-evidence-output.schema.json
// DO NOT EDIT MANUALLY — regenerate from canonical schema

/**
 * Output schema for document_evidence_json.v1 service. Must be a valid PCC 1.0.0 document
 * with required net.siteborne.document-evidence.v1 extension.
 *
 ...
 */
export interface DocumentEvidenceOutput {
  claims: Claim[];
 ...
 * Service identifier
 */
export type ServiceID = 'document_evidence_json.v1';
