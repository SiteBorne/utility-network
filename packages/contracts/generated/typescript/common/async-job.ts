 ...
 * Closed error category.
 */
export type Category = "validation" | "authorization" | "payment_required" | "payment_invalid" | "rate_limited" | "unsupported" | "unavailable" | "provider_failure" | "verification_failure" | "conflict" | "duplicate" | "internal" | "quarantined";
 ...
 * Current job state.
 */
export type State = "accepted" | "queued" | "executing" | "verifying" | "settling" | "delivered" | "failed" | "quarantined" | "refund_required";
