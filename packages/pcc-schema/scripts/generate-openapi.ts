...
const SERVICE_IDS = {
  'company-evidence-output': 'company_evidence_graph.v2',
  'web-context-output': 'web_context_verified.v2',
  'document-evidence-output': 'document_evidence_json.v2',
  'agent-verification-output': 'verify_agent_output.v2',
};
...
const SERVICE_OPERATIONS = {
  'company_evidence_graph.v2': 'companyEvidenceGraph',
  'web_context_verified.v2': 'webContextVerified',
  'document_evidence_json.v2': 'documentEvidenceJson',
  'verify_agent_output.v2': 'verifyAgentOutput',
};
  ...
  for (const [serviceId, path] of Object.entries(SERVICE_PATHS)) {
    ...
    openapi.paths[path] = {
      post: {
        ...
        description: `Service contract for ${serviceId}. Locally fixture-verified (SUN-1000 checkpoint 1M) - not production-enabled.`,
