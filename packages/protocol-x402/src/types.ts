 ...
 * parallel v2 service IDs this package can bind a payment requirement to —
 * kept in sync with @siteborne/service-runtime's ServiceId/ALL_SERVICE_IDS
 * by convention, not by a cross-package type import (service-runtime and
 * protocol-x402 are independent packages; a payment can be quoted for a
 * service before that service ever executes). */
